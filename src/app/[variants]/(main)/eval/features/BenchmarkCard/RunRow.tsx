...
const RunRow = memo<RunRowProps>(
  ({
    ...
    return (
      ...
      >
        <Flexbox align="center" className={styles.row} gap={12} horizontal>
          <Flexbox flex={1} gap={2} style={{ minWidth: 0 }}>
            ...
            <Flexbox align="center" className={styles.meta} gap={4} horizontal>
              ...
              {model && agentName && <span className={styles.separator}>/</span>}
          ...
          <Icon icon={ArrowRight} size={14} style={{ color: 'var(--ant-color-text-tertiary)', flexShrink: 0 }} />
        </Flexbox>
      </Link>
    );
  },
